...
if (isset($_POST['submit'])) {
    ...
    if ($nama && $nip && $pelajaran) {
        $query = mysqli_query($koneksi, "UPDATE guru SET nama = '$nama', nip = '$nip', pelajaran = '$pelajaran' WHERE id = $id");
        if ($query) {
            ...
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nip" id="nip" value="<?php echo $nip ?>" class="form-control" autofocus
                            required>
                    </div>
                    <div class="mb-3">
